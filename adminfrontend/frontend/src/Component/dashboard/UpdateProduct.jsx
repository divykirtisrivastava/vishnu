...
const UpdateProduct = () => {
    ...
    useEffect(() => {
        const fetchProductDetails = async () => {
            try {
                const response = await axios.get(`https://actl.co.in/shop/getProduct/${id}`);
...
console.log(productData)
        try {
            await axios.put(`https://actl.co.in/shop/updateProduct/${id}`, formData, {
                headers: {
                ...
                <div className="mb-4">
                    ...
                    <div className="flex">
                        {existingImages.map((image, index) => (
                            <img
                                key={index}
                                src={`https://actl.co.in/uploads/${image}`} // Assuming your images are stored in a public folder
                                alt="product"
